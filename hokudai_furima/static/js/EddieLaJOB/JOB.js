 ...
 */
/*
注意：グローバル変数を参照する必要があります
- exifjsFilePath: exif.jsのファイルパス
- decoderWorkerFilePath: DecodeWorker.jsのファイルパス
*/
...
JOB = {
	...
	DecoderWorker : new Worker(decoderWorkerFilePath),
