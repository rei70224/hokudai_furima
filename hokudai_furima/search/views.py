...
def search_product(request):
    ...
    return render(request, 'search/product/search_product.html', {'keyword_form': keyword_form, 'option_form': option_form, 'is_searched': False})
    ...
    if not query_keyword_string:
        ...
        for word in query_words:
            ...
            for is_sold_flag in is_sold_flags:
                records_per_word += Product.objects.filter(title__icontains=word, price__gte=price_range_pair[0], price__lt=price_range_pair[1], is_sold=is_sold_flag)
